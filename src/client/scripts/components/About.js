...
export default class About extends React.Component {
  ...
  render() {
    return (
      <div className="about">
        <div className="about__title about__title--current-job">Currently building impactful products at <a href="http://www.codeandcraft.nyc" target="_blank">Code and Craft</a> through user research, rapid prototyping and lots of coffee.
        </div>
