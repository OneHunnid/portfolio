  ...
  render() {
    return (
      <div className="about js-showtime">
        <div className="about__title about__title--current-job">Currently tackling the music industry at <a href="http://www.ascap.com" target="_blank">ASCAP</a> by improving the experiences of multiple digital touchpoints.
        </div>
        <div className="about__title about__title--previous-job">I built and launched impactful products at <a href="http://www.codeandcraft.nyc" target="_blank">Code and Craft</a> through user research, wireframing, and rapid development.
        </div>
